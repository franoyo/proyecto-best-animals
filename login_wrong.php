...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/style2.css?2.0" media="all" >
    <link rel="stylesheet" href="login_roles.php" />
</head>
...
<div class="cont2">
  <form class="formu" action="login_roles.php" method="post">
    ...
    <br>
    <input class="boton" id="iniciar sesion" name="ingresar"  type="submit" value="iniciar sesion">
</form>

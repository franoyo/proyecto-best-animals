...
<div class="container-form" id="CR">
    <div class="row1">
        ...
        <div class="container-input-2">
            <input class="input-2" type="text" name="nombre_empleado" value="<?= $dataz->nombre?>" readonly>
    ...
    <div class="row1">  <div class="mitad-1">
        ...
        <div class="container-input">
<input class="input-1" type="text" name="apellido_empleado" value="<?= $dataz->apellidos   ?>" readonly>

        </div> 
    </div>
    <div class="mitad-2"><div class="subtitle-2">DOCUMENTO:</div>
    <div class="container-input-2">
        <input class="input-2" type="text" name="documento_empleado" value="<?= $dataz->documento?>" readonly>

    </div> </div></div>
    <div class="row1">  <div class="mitad-1">
        <div class="subtitle">CELULAR:</div>
        <div class="container-input">
            <input class="input-1" type="number" name="celular_empleado" value="<?= $dataz->celular?>"  maxlength="10" readonly>

        </div>  
    </div>
    <div class="mitad-2"><div class="subtitle-2">DIRECCION:</div>
    <div class="container-input-2">
        <input class="input-2" type="text" name="direccion_empleado" value="<?= $dataz->direccion?>" readonly>
    ...
    <div class="row1">  <div class="mitad-1">
        ...
        <div class="container-input">
            <input class="input-1" type="text" name="ciudad_empleado" value="<?= $dataz->ciudad?>" readonly>
        </div> 
    </div>
    <div class="mitad-2"><div class="subtitle-2">EMAIL:</div>
    <div class="container-input-2">
        <input class="input-2" type="email" name="email_empleado" value="<?= $dataz->email?>" readonly>
    </div> 
</div></div>
    <div class="row1">  <div class="mitad-1">
        <div class="subtitle">CLAVE:</div>
        <div class="container-input">
            <input class="input-1" type="text" name="clave_empleado" value="<?= $dataz->clave?>" readonly>
        </div>  
    </div>
    <div class="mitad-2"><div class="subtitle-2">ROL ID:</div>
    <div class="container-input-2">
        <select class="input-2" name="rol_id">
